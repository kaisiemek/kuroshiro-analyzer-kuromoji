...
"use strict";var DictionaryLoader=require("./DictionaryLoader");function BrowserDictionaryLoader(r){DictionaryLoader.apply(this,[r])}BrowserDictionaryLoader.prototype=Object.create(DictionaryLoader.prototype),BrowserDictionaryLoader.prototype.loadArrayBuffer=function(r,o){var e=new XMLHttpRequest;e.open("GET",r,!0),e.responseType="arraybuffer",e.onload=function(){this.status>0&&200!==this.status?o(e.statusText,null):o(null,new Uint8Array(this.response).buffer)},e.onerror=function(r){o(r,null)},e.send()},module.exports=BrowserDictionaryLoader;

},{"./DictionaryLoader":17}],17:[function(require,module,exports){
"use strict";var path=require("path"),async=require("async"),DynamicDictionaries=require("../dict/DynamicDictionaries");function DictionaryLoader(n){this.dic=new DynamicDictionaries,this.dic_path=n}DictionaryLoader.prototype.loadArrayBuffer=function(n,t){throw new Error("DictionaryLoader#loadArrayBuffer should be overwrite")},DictionaryLoader.prototype.load=function(n){var t=this.dic,i=this.dic_path,r=this.loadArrayBuffer;async.parallel([function(n){async.map(["base.dat","check.dat"],function(n,t){r(path.join(i,n),function(n,i){if(n)return t(n);t(null,i)})},function(i,r){if(i)return n(i);var a=new Int32Array(r[0]),o=new Int32Array(r[1]);t.loadTrie(a,o),n(null)})},function(n){async.map(["tid.dat","tid_pos.dat","tid_map.dat"],function(n,t){r(path.join(i,n),function(n,i){if(n)return t(n);t(null,i)})},function(i,r){if(i)return n(i);var a=new Uint8Array(r[0]),o=new Uint8Array(r[1]),e=new Uint8Array(r[2]);t.loadTokenInfoDictionaries(a,o,e),n(null)})},function(n){r(path.join(i,"cc.dat"),function(i,r){if(i)return n(i);var a=new Int16Array(r);t.loadConnectionCosts(a),n(null)})},function(n){async.map(["unk.dat","unk_pos.dat","unk_map.dat","unk_char.dat","unk_compat.dat","unk_invoke.dat"],function(n,t){r(path.join(i,n),function(n,i){if(n)return t(n);t(null,i)})},function(i,r){if(i)return n(i);var a=new Uint8Array(r[0]),o=new Uint8Array(r[1]),e=new Uint8Array(r[2]),c=new Uint8Array(r[3]),u=new Uint32Array(r[4]),d=new Uint8Array(r[5]);t.loadUnknownDictionaries(a,o,e,c,u,d),n(null)})}],function(i){n(i,t)})},module.exports=DictionaryLoader;
